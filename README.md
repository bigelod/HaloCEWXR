[![Youtube Video](https://github.com/user-attachments/assets/438ca111-8537-4952-8c25-e4ca9b1412f3)](https://www.youtube.com/watch?v=b96l7AQHDYs)
<!-- Generated by https://t.cuts.so/github/video -->


# WinlatorXR 6DOF API support for the Halo: Combat Evolved PC VR Mod
...
Code added or modified from the parent project in this fork/port to WinlatorXR's XrApi is subject to the [LGPLv3 license](https://www.gnu.org/licenses/lgpl-3.0.en.html) so that others may adapt it for their own C++ PCVR games and mods as well!
